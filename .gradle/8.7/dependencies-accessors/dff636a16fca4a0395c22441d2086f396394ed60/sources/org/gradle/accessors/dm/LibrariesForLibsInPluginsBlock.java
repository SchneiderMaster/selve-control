...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ProtolayoutLibraryAccessors laccForProtolayoutLibraryAccessors = new ProtolayoutLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>protolayout</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ProtolayoutLibraryAccessors getProtolayout() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForProtolayoutLibraryAccessors;
    }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxProtolayoutLibraryAccessors laccForAndroidxProtolayoutLibraryAccessors = new AndroidxProtolayoutLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.protolayout</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxProtolayoutLibraryAccessors getProtolayout() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxProtolayoutLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxProtolayoutLibraryAccessors extends SubDependencyFactory {

        public AndroidxProtolayoutLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>expression</b> with <b>androidx.wear.protolayout:protolayout-expression</b> coordinates and
         * with version reference <b>protolayout</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getExpression() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.protolayout.expression");
        }
     ...
     */
    @Deprecated
    public static class AndroidxTilesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>tilesVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getRenderer() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.tiles.renderer");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getTesting() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.tiles.testing");
        }
     ...
     */
    @Deprecated
    public static class ProtolayoutLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public ProtolayoutLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>protolayout</b> with <b>androidx.wear.protolayout:protolayout</b> coordinates and
         * with version reference <b>protolayout</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getMaterial() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("protolayout.material");
        }
    ...
    public static class TilesLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v140</b> with <b>androidx.wear.tiles:tiles</b> coordinates and
         * with version reference <b>tilesVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>concurrentFutures</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>protolayout</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getProtolayout() { return getVersion("protolayout"); }
        ...
        /**
         * Version alias <b>tilesVersion</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTilesVersion() { return getVersion("tilesVersion"); }
